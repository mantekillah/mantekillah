...
I'm `Víctor Palomares` but I'm also known as `Palo`, `Cux`, `BLZ`, `senyirauxa`, `aintyabro`, `mantekillah` or `mantekiller` and I like to define myself as an `anarcho-pacifist` guy from the `Catalan Nation Lands`.
