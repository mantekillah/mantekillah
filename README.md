...
I'm `Víctor Palomares` but I'm also known as `Palo`, `Cux`, `senyirauxa`, `aintyabro`, `mantekillah`/`mantekiller` or `BLZ` and I like to define myself as an `anarcho-pacifist` guy from the `Catalan Nation Lands`.
