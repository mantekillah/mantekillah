...
I'm `Víctor Palomares` but I'm also known as `BLZ`, `Palo`, `Vittorio`, `BiGTORT`, `Big-T`, `Viti`, `Cux`, `Uktrend`, `biktwp`, `senyirauxa`, `aintyabro` or `mantekillah` and I like to define myself as an `anarcho-pacifist` guy from the `Catalan Nation Lands`.
